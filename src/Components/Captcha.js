...
import studentIMG from '../Images/user.png';
  ...
  const onSubmit = e => {
   ...
   return (
    <div className="container">
      ...
      <div>
          <div>
            <h4 id="captcha" style={{ marginTop:"370px",marginLeft:"25px",position:"absolute"}}>{captcha}</h4>
            
            <div>
            <input type="text" placeholder=' Full Name...' onChange={(e) => setUserName(e.target.value)} /> <hr/>
            ...
            <div>
              <img src={studentIMG} className="student-img" height="90"/> <span className="font-weight-bold ml-3"  style={{ marginTop:"50px"}} >{userName}</span>
            </div>
            <div>
            ...
            <div>
              <input type="text" id="inputType" className="form-control"placeholder="Enter Captcha"
                ...
                />
              <button type="button" id="succesBTN" onClick={onSubmit} className="btn btn-primary ml-1">Verify Captcha</button>
